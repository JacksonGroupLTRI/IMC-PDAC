...
Stabl_Binary_Predictions_LateFusions_for_SingleOmic_AUROCs.ipynb contains the script for running each omics dataset separately to determine the relative AUROC distributions possible with each dataset. The comparison between models built on Clinical, IMC, Genomic, or All Omics datasets is shown in the boxplot in Figure 6c.
